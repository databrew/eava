...
all_causes <- causes %>%
  mutate( country = "Mali",
          filename = "CHAMPS_Verbal_Autopsy_Form_results_babel.csv")
...
all_causes <- rbind( all_causes, 
                     causes %>% 
                       mutate( country = "Mali", 
                               filename = "CHAMPS_Verbal_Autopsy_Form_v2_04_1_results_babel.csv") )
age_group_table( causes )
```
...
all_causes <- rbind( all_causes, 
                     causes %>% 
                       mutate( country = "Mali", 
                               filename = "CHAMPS_Verbal_Autopsy_Form_v2_04_results_babel.csv") )
age_group_table( causes )
```
...
all_causes <- rbind( all_causes, 
                     causes %>% 
                       mutate( country = "Mali", 
                               filename = "VA_Death_of_a_child_under_4_weeks_to_59_months_results_21MAR2018_babel.csv") )
age_group_table( causes )
```
...
all_causes <- rbind( all_causes, 
                     causes %>% 
                       mutate( country = "Gambia", 
                               filename = "VA_Child_WHO2016_babel.csv") )
age_group_table( causes )
```
...
all_causes <- rbind( all_causes, 
                     causes %>% 
                       mutate( country = "Gambia", 
                               filename = "VA_ChildForm_WHO2012_babel.csv") )
age_group_table( causes )
```
...
all_causes <- rbind( all_causes, 
                     causes %>% 
                       mutate( country = "Gambia", 
                               filename = "VA_Child_Indepth_2008-2012_clean duration_babel.csv") )
age_group_table( causes )
```
...
all_causes <- rbind( all_causes, 
                     causes %>% 
                       mutate( country = "Gambia", 
                               filename = "VA_Child_Indepth_2008-2012_babel.csv") )
age_group_table( causes )
```
...
all_causes <- rbind( all_causes, 
                     causes %>% 
                       mutate( country = "Gambia", 
                               filename = "VA_Child_WHO2012-mid 2016_babel.csv") )
age_group_table( causes )
```
